...
<section class="lb-ecosystem">
  <div class="lb-ecosystem__header">
    ...
    <p class="lb-eco-note">Only <strong>LazyBridge</strong> is published on PyPI. Everything else installs from GitHub at a pinned release tag &mdash; copy the command on each card.</p>
  </div>
  ...
  <div class="lb-ecosystem__cards">
    ...
    <a href="https://pulse.lazybridge.com/" class="lb-eco-card">
      ...
      <div class="lb-eco-card__footer">
        <code>pip install "lazypulse @ git+https://github.com/selvaz/LazyPulse.git@v0.3.1"</code>
        <span class="lb-eco-arrow">&rarr;</span>
      </div>
    </a>
    ...
    <a href="https://tools.lazybridge.com/" class="lb-eco-card">
      ...
      <div class="lb-eco-card__footer">
        <code>pip install "lazytoolkit @ git+https://github.com/selvaz/LazyTools.git@v0.3.2"</code>
        <span class="lb-eco-arrow">&rarr;</span>
      </div>
    </a>
    ...
    <a href="https://github.com/selvaz/LazyCrawler" class="lb-eco-card">
      ...
      <div class="lb-eco-card__footer">
        <code>pip install "lazycrawler @ git+https://github.com/selvaz/LazyCrawler.git@v0.15.0"</code>
        <span class="lb-eco-arrow">&rarr;</span>
      </div>
    </a>
    ...
    <a href="https://github.com/selvaz/market-data-hub" class="lb-eco-card">
      ...
      <div class="lb-eco-card__footer">
        <code>pip install "market-data-hub @ git+https://github.com/selvaz/market-data-hub.git@&lt;ref&gt;"</code>
        <span class="lb-eco-arrow">&rarr;</span>
      </div>
    </a>
